                    ...
                    <el-form :inline="true" label-width="120px">
                        ...
                        <el-form-item label="订单来源：">
                            <el-select v-model="origin" placeholder="全部来源">
                                <el-option label="北京好中医" value="app"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="">
                    ...
                    <table v-for="(item,i) in orderList" :key="i">
                        <tr>
                            <td colspan="6">
                                ...
                                <span>问诊单号：{{item.orderNumber}}</span>
                                <span></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><span><img src="../../assets/img/wechat@3x.png" />{{item.paymentMethod}}</span></td>
                            <td><span style="color:#D74326;">¥ {{Number(item.actualPayment).toFixed(2)}}</span></td>
...
export default {
    ...
    methods:{
        ...
        getConsultOrder(){
            ...
            this.$doRequest('/api/order/inquiry/search', params,function(res){
        ...
        //查看详情
        goDetails(id){
            this.$router.push({path: '/consultDetails',query:{id: id}});
        }
    },
    created(){
        this.getConsultOrder();
