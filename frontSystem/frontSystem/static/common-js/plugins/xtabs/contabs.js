$(function() {
    ...
    function n() {
        ...
        if (!t) {
        	t = $(this).attr("href");
        	$(this).attr("href_bak", $(this).attr("href"));
            this.href = "javascript:;";
        }

        if (void 0 == t || 0 == $.trim(t).length) return ! 1;
        if(t == 'javascript:;') return !1
        if($(".J_menuTab").length < 9){
            if ($(".J_menuTab").each(function() {
                ...
                var s = '<a href="javascript:;" class="active J_menuTab" data-id="' + t + '"><i class="fa fa-file-text-o fa-fw"></i> ' + i + ' <i class="fa fa-times-circle"></i></a>';
                top.window.$(".J_menuTab").removeClass("active");
                var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + t + '" frameborder="0" data-id="' + t + '" seamless></iframe>';
                top.window.$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(r);
                var o = layer.load();
                top.window.$(".J_mainContent iframe:visible").load(function() {
                    layer.close(o)
                }),
                    top.window.$(".J_menuTabs .page-tabs-content").append(s),
                    e(top.window.$(".J_menuTab.active"))
            }
        }else{
            bootbox.alert({
                buttons: {
